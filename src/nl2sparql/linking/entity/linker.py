...
# Audited, static English function/question vocabulary for thesis-style
# requests.  It is deliberately limited to grammatical words and request
# scaffolding, not domain-bearing nouns or verbs.  Semantic windows must retain
# one word outside these classes; exact aliases deliberately bypass this policy.
...
_STOPWORDS = frozenset(word for _group, words in _FUNCTION_WORD_GROUPS for word in words)
